	...
	MenuItems: Array<IContextualMenuItem> = [
		{
			...
			onClick: (event) => {
				...
				this.setState({ ShowDatepicker: true, ShowDropdown: false, ShowList: false, ShowPeoplePicker: false });
			}
		},
		{
			key: 'dropdown',
			...
			onClick: (event) => {
				event.preventDefault();
				this.setState({ ShowDatepicker: false, ShowDropdown: true, ShowList: false, ShowPeoplePicker: false });
			}
		},
		{
			key: 'list',
			...
			onClick: (event) => {
				event.preventDefault();
				this.setState({ ShowDatepicker: false, ShowDropdown: false, ShowList: true, ShowPeoplePicker: false });
			}
		},
		{
			key: 'peoplePicker',
			...
			onClick: (event) => {
				event.preventDefault();
				this.setState({ ShowDatepicker: false, ShowDropdown: false, ShowList: false, ShowPeoplePicker: true });
			}
		}
	];
