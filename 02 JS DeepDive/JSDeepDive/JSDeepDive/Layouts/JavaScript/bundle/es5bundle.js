...
function stringFunctions() {
  ...
  console.log("chars included in yr string: ".concat(countString("abheben")));
}
...
function arrayHelpers() {
  ...
  console.log(fruitNames); //look for balanced parenthesis

  function checkBalancedParanthesis(string) {
    return string.split("").reduce(function (prev, _char) {
      if (prev < 0) {
        return prev;
      }
