...
$(document).ready(function () {
    ...
    appUrl = window.location.protocol + "//" + window.location.host + _spPageContextInfo.webServerRelativeUrl;
...
function GetVouchers() {
    ...
    var url = appUrl + "/_api/SP.AppContextSite(@target)/web/lists/getByTitle('Vouchers')/Items?@target='" + hostUrl + "'";
