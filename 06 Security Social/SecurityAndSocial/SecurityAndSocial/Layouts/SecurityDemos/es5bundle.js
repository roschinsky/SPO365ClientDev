...
function addUserToGroup() {
    ...
    uci.set_email('jbrown@somewhere.com');
    uci.set_loginName('sp\\jbrown');
    uci.set_title('John Brown');
...
function createUser() {
    ...
    var uci = new SP.UserCreationInformation();
    uci.set_email('donald.duck@somewhere.com');
    uci.set_loginName('sp\\donald.duck');
...
function retrieveUser() {
    debugger;
    var cc = new SP.ClientContext();
    var user = cc.get_web().get_siteUsers().getByLoginName('sp\\donald.duck');
    cc.load(user);
    cc.executeQueryAsync(function () {
...
function assignRoleToUser() {
    ...
    var usr = web.get_siteUsers().getByLoginName('sp\\administrator');
...
function breakInheritanceAddUser() {
    ...
    var cc = new SP.ClientContext();
    var list = cc.get_web().get_lists().getByTitle('News');
    var li = list.getItems().getById(1);
    li.breakRoleInheritance(false);
    var usr = cc.get_web().get_siteUsers().getByLoginName('sp\\administrator');
...
function loadUserProfile() {
    debugger;
    var targetUser = "sp\\administrator";
...
function followCurrentSite() {
    ...
    context.executeQueryAsync(function () {
        console.log('Now following the current site!');
...
function clientSidePeoplePicker() {
    debugger;
...
var SecurityHelper = function () {
    function SecurityHelper() {
        _classCallCheck(this, SecurityHelper);
    }

    _createClass(SecurityHelper, [{
        key: "createGroup",
