...
namespace Provisioning.ModernPages
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string siteUrl = "https://integrationseu.sharepoint.com/sites/modernpagedemo";
            string userName = "dev@mysharepoint.at";
            SecureString password = GetSecureString("Enter your Password");
            ...
            using (var cc = am.GetSharePointOnlineAuthenticatedContextTenant(siteUrl, userName, password))
            {
                ...
                */
                ...
                var myHellowWorldWebPart = componentsToAdd.FirstOrDefault(s => s.Name == "HelloWorld");
