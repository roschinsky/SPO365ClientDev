...
var NewsListComponent = /** @class */ (function () {
    function NewsListComponent(ns) {
        this.ns = ns;
    }
    NewsListComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.ns.getNews().subscribe(function (data) { return (_this.items = data.value); });
    };
    NewsListComponent.prototype.showNews = function (item) {
        this.current = item;
    };
    NewsListComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: "app-news-list",
            template: __webpack_require__(/*! ./news-list.component.html */ "./src/app/News/news-list/news-list.component.html"),
            styles: [__webpack_require__(/*! ./news-list.component.scss */ "./src/app/News/news-list/news-list.component.scss")]
        }),
...
var NewsService = /** @class */ (function () {
    ...
    NewsService.prototype.getNews = function () {
        return this.httpClient.get(this.rootUrl + "/_api/web/lists/getByTitle('News')/items");
...
var AppComponent = /** @class */ (function () {
    function AppComponent() {
        this.title = "the new shiny world";
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [_app_component__WEBPACK_IMPORTED_MODULE_3__["AppComponent"], _News_news_list_news_list_component__WEBPACK_IMPORTED_MODULE_4__["NewsListComponent"]],
