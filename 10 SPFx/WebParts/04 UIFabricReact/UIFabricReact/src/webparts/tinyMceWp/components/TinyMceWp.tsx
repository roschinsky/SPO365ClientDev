...
import styles from "./TinyMceWp.module.scss";
import { ITinyMceWpProps } from "./ITinyMceWpProps";
 ...
 */
export default class TinyMceWp extends React.Component<
  ITinyMceWpProps,
  IReactTinyMceState
> {
  /**
   ...
   */
  public constructor(props: ITinyMceWpProps) {
    super(props);
    tinymce.init({});
    this.state = {
   ...
   * @memberof ReactTinyMce
   */
  public render(): React.ReactElement<ITinyMceWpProps> {
    return (
      <div className={styles.tinyMceWp}>
        {this.props.isReadMode ? this.renderReadMode() : this.renderEditMode()}
      </div>
    );
  }
   ...
   * @memberof ReactTinyMce
   */
  private renderEditMode(): React.ReactElement<ITinyMceWpProps> {
    return (
      <div className="tinyMceEditMode">
        <Editor
          ...
          onChange={event => {
            this.handleChange(event.target.getContent());
          }}
        />
      </div>
    );
