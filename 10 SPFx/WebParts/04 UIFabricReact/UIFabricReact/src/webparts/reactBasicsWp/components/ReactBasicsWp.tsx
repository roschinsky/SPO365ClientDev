...
import styles from "./ReactBasicsWp.module.scss";
import { IReactBasicsWpProps } from "./IReactBasicsWpProps";
...
export default class ReactBasicsWp extends React.Component<
  IReactBasicsWpProps,
  any
> {
  constructor() {
