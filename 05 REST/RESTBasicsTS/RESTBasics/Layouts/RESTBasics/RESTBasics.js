...
function updateList() {
  ...
  var update = JSON.stringify({
    __metadata: { type: "SP.List" },
    Description: "A list to test the REST Samples"
  });
  $.ajax({
    url:
      _spPageContextInfo.webAbsoluteUrl +
      "/_api/web/lists/GetByTitle('MyRestList')",
    type: "POST",
    data: update,
    headers: {
      accept: "application/json;odata=verbose",
...
function addField() {
  ...
  var query =
    _spPageContextInfo.webAbsoluteUrl +
    "/_api/web/lists/GetByTitle('MyRestList')/Fields";
  $.ajax({
    url: query,
    type: "POST",
    data: fld,
...
function getItems() {
  ...
  $.ajax({
    url:
      _spPageContextInfo.webAbsoluteUrl +
      "/_api/lists/getByTitle('News')/Items?$select=Title",
    type: "GET",
    headers: {
      Accept: "application/json;odata=verbose",
      "Content-Type": "application/json; odata=verbose"
...
function doExpanding() {
  ...
  var url =
    _spPageContextInfo.webAbsoluteUrl +
    "/_api/lists/getByTitle('News')/Items?$select=LinkTitle,Author/Name&$expand=Author";
  $.ajax({
    url: url,
    type: "GET",
    headers: {
...
function getUserProps() {
  ...
  execProfileQuery(
    "_api/SP.UserProfiles.PeopleManager/GetPropertiesFor(accountName=@v)?@v='spdom\\administrator'"
  );
}
...
function usingGetItems() {
  ...
  $.ajax({
    url:
      _spPageContextInfo.webAbsoluteUrl +
      "/_api/web/lists/getbytitle('News')/GetItems(query=@v1)?@v1={\"ViewXml\":\"<View><Query><OrderBy><FieldRef Name='Created' /></OrderBy></Query></View>\"}",
    type: "POST",
    headers: {
      "X-RequestDigest": $("#__REQUESTDIGEST").val(),
      Accept: "application/json;odata=verbose",
...
function addListItem() {
  ...
  $.ajax({
    url:
      _spPageContextInfo.webAbsoluteUrl +
      "/_api/web/lists/getbytitle('MyRestList')/items",
    type: "POST",
